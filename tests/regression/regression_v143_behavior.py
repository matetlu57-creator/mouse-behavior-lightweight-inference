...
def main() -> int:
    ...
    print(
        f"  formal_id_count: {bt['formal_id_count']} -> {nt['formal_id_count']} | equal={id_equal}"
    )
    print(
        f"  raw_to_logical_switch_count: {bt['raw_to_logical_switch_count']} -> {nt['raw_to_logical_switch_count']} | equal={switch_equal}"
    )
